...
Partial Public Class ProDS
    ...
    Partial Public Class BitacoraMCDataTable
        ...
        Public Overloads Function AddBitacoraMCRow( _
                    ...
                    ByVal Nombre_Sucursal As String) As BitacoraMCRow
            Dim rowBitacoraMCRow As BitacoraMCRow = CType(Me.NewRow,BitacoraMCRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Anexo, Ciclo, Pagare, PagareORG, PagareTXT, Contrato, ContratoORG, ContratoTXT, Convenio, ConvenioORG, ConvenioTXT, Escritura, EscrituraORG, EscrituraTXT, Facturas, FacturasORG, FacturasTXT, Garantias, GarantiasORG, GarantiasTXT, FechaSolicitud, FechaEntrega, FechaDevolucion, Justificacion, Nota, Solicito, vobo, AnexoCon, TipoCredito, Descr, Autoriza, AuditoriaExterna, NoAdeudo, VoboB, AutorizaB, Nombre_Sucursal}
        ...
        Private Sub InitClass()
            ...
            Me.columnJustificacion.MaxLength = 200
    ...
    Partial Public Class AvioVoboDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddAvioVoboRow(ByVal AnexoCon As String, ByVal CicloPagare As String, ByVal Descr As String, ByVal Nombre_Sucursal As String, ByVal Importe As Decimal, ByVal FechaAlta As Date, ByVal Cultivo As String, ByVal Ministracion As Byte, ByVal TipoCredito As String, ByVal Solicito As String, ByVal Anexo As String, ByVal Documento As String, ByVal Vobo As String, ByVal MesaControl As String, ByVal Autoriza As String) As AvioVoboRow
            Dim rowAvioVoboRow As AvioVoboRow = CType(Me.NewRow,AvioVoboRow)
            Dim columnValuesArray() As Object = New Object() {AnexoCon, CicloPagare, Descr, Nombre_Sucursal, Importe, FechaAlta, Cultivo, Ministracion, TipoCredito, Solicito, Anexo, Documento, Vobo, MesaControl, Autoriza}
    ...
    Partial Public Class BitacoraMCTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        MC_Bitacora.Id_Bitacora, MC_Bitacora.Anexo, MC_Bitacora.Ciclo, MC_B"& _ 
                ...
                "Vw_Anexos.Nombre_Sucursal"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            MC_Bitacora INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"             "& _ 
                "            Vw_Anexos ON MC_Bitacora.Anexo = Vw_Anexos.Anexo AND MC_Bitacora.Cic"& _ 
                "lo = Vw_Anexos.Ciclo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (MC_Bitacora.Id_Bitacora = @ID)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).CommandText = "SELECT        MC_Bitacora.Id_Bitacora, MC_Bitacora.Anexo, MC_Bitacora.Ciclo, MC_B"& _ 
                ...
                "Bitacora.Solicito, MC_Bitacora.vobo, Vw_Anexos.AnexoCon, Vw_Anexos.TipoCredito, "& _ 
                "Vw_Anexos.Descr, MC_Bitacora.Autoriza, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         MC_Bitacora.Au"& _ 
                "ditoriaExterna, MC_Bitacora.NoAdeudo, MC_Bitacora.VoboB, MC_Bitacora.AutorizaB"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                ...
                "        (MC_Bitacora.Solicito = @Solicito) AND (MC_Bitacora.vobo = @Vobo) AND (M"& _ 
                "C_Bitacora.VoboB = 0) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (MC_Bitacora.Solicito = @Soli"& _ 
                "cito) AND (MC_Bitacora.Autoriza = @Autoriza) AND (MC_Bitacora.AutorizaB = 0)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Solicito", Global.System.Data.SqlDbType.NChar, 10, Global.System.Data.ParameterDirection.Input, 0, 0, "Solicito", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Vobo", Global.System.Data.SqlDbType.NChar, 10, Global.System.Data.ParameterDirection.Input, 0, 0, "vobo", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Autoriza", Global.System.Data.SqlDbType.NChar, 10, Global.System.Data.ParameterDirection.Input, 0, 0, "Autoriza", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
    ...
    Partial Public Class AvioVoboTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Vw_Anexos.AnexoCon, Vw_Anexos.CicloPagare, Vw_Anexos.Descr, Vw_Anex"& _ 
                ...
                "IL.Documento, mFINAGIL.Vobo, mFINAGIL.MesaControl, mFINAGIL.Autoriza"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM      "& _ 
                ...
                "= Vw_Anexos.Anexo AND mFINAGIL.Ciclo = Vw_Anexos.Ciclo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (mFINAGIL.V"& _ 
                "obo = @User) AND (mFINAGIL.VoboAut = 0) AND (Vw_Anexos.TipoCredito <> 'ANTICIPO "& _ 
                "AVÍO') AND (mFINAGIL.Procesado = 0)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(2).CommandText = "UPDATE       mFINAGIL"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                AutorizaAut = 1, MesaControl = 'MesaCon"& _ 
                "trolX'"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Anexo = @Anexo) AND (Ministracion = @Ministracion)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(6).CommandText = "SELECT        Vw_Anexos.AnexoCon, Vw_Anexos.CicloPagare, Vw_Anexos.Descr, Vw_Anex"& _ 
                ...
                "IL.Documento, mFINAGIL.Vobo, mFINAGIL.MesaControl, mFINAGIL.Autoriza"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM      "& _ 
                "      mFINAGIL INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Vw_Anexos ON mFINAGIL.Anexo "& _ 
                "= Vw_Anexos.Anexo AND mFINAGIL.Ciclo = Vw_Anexos.Ciclo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Vw_Anexos."& _ 
                "TipoCredito = 'ANTICIPO AVÍO') AND (mFINAGIL.Procesado = 0) AND (mFINAGIL.Autori"& _ 
                "za = @User) AND (mFINAGIL.AutorizaAut = 0)"
            ...
            Me._commandCollection(7).CommandText = "SELECT        Vw_Anexos.AnexoCon, Vw_Anexos.CicloPagare, Vw_Anexos.Descr, Vw_Anex"& _ 
                ...
                " AS FechaAlta, Vw_Anexos.Cultivo, mFINAGIL.Ministracion, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                     "& _ 
                "    Vw_Anexos.TipoCredito, mFINAGIL.Usuario AS Solicito, Vw_Anexos.Anexo, mFINAG"& _ 
                "IL.Documento, mFINAGIL.Vobo, mFINAGIL.MesaControl, mFINAGIL.Credito AS Autoriza"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            mFINAGIL INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Vw_Anexos ON mFIN"& _ 
                ...
                "(Vw_Anexos.TipoCredito <> 'ANTICIPO AVÍO') AND (mFINAGIL.Procesado = 0) AND (mFI"& _ 
                "NAGIL.Credito = @User) AND (mFINAGIL.CreditoAut = 0)"
            ...
            Me._commandCollection(8).CommandText = "SELECT        Vw_Anexos.AnexoCon, Vw_Anexos.CicloPagare, Vw_Anexos.Descr, Vw_Anex"& _ 
                ...
                "      mFINAGIL INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Vw_Anexos ON mFINAGIL.Anexo "& _ 
                "= Vw_Anexos.Anexo AND mFINAGIL.Ciclo = Vw_Anexos.Ciclo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Vw_Anexos."& _ 
                "Anexo = @Anexo) AND (mFINAGIL.Ministracion = @Ministracion)"
            ...
            Me._commandCollection(9).CommandText = "SELECT        Vw_Anexos.AnexoCon, Vw_Anexos.CicloPagare, Vw_Anexos.Descr, Vw_Anex"& _ 
                ...
                "      mFINAGIL INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Vw_Anexos ON mFINAGIL.Anexo "& _ 
                "= Vw_Anexos.Anexo AND mFINAGIL.Ciclo = Vw_Anexos.Ciclo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (mFINAGIL.V"& _ 
                "obo = @User) AND (mFINAGIL.VoboAut = 0) AND (mFINAGIL.Procesado = 0) AND (Vw_Ane"& _ 
                "xos.TipoCredito = 'ANTICIPO AVÍO')"
