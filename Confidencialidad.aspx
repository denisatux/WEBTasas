...
<body onload="window.resizeTo(640,380)">
...
<FORM ACTION="Confidencialidad_2.aspx" METHOD="GET">

<br /><br /><br /><p> <strong>A QUIEN CORRESPONDA</strong></p>    <br />
...
%>
    <div align="CENTER"> 
        <input type="hidden" id="acticuloId" name="host" value="<%Response.Write(Request.ServerVariables("REMOTE_HOST")) %>"><BR>
