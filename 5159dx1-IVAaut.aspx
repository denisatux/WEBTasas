<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="5159dx1-IVAaut.aspx.vb" Inherits="WEBTasas.FRM_IVAaut" %>
...
<body>
    ...
    <td style="font-weight: bold; vertical-align: middle; color: white; font-family: Verdana; background-color: #ff6600; text-align: center">
        <br />
        Autorización de Tasa de IVA</td>
    </tr>
        <tr>
    <td align=center>
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1" EnableModelValidation="True" Font-Names="verdana,smaller" Font-Size="Smaller" ForeColor="#333333" GridLines="None" DataKeyNames="Anexo,Ciclo">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Anexo">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "5159dx1-IVAaut.aspx?User=" & Request("User") & Eval("Anexo", "&Anexo={0}")  & Eval("Ciclo", "&Ciclo={0}") %>' Text='<%# Eval("AnexoCon") %>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="WEBTasas.ProDSTableAdapters.AutorizaIVATableAdapter">
        ...
        <asp:ObjectDataSource ID="vwDatos_DS" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetDataByAnexo" TypeName="WEBTasas.ProDSTableAdapters.AutorizaIVATableAdapter">
            <SelectParameters>
