<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="232db951-DGxa.aspx.vb" Inherits="WEBTasas.DGSucursalForm" %>
...
<body>
    ...
    <td align=center>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1" EnableModelValidation="True" Font-Names="verdana,smaller" Font-Size="Smaller" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Anexo">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("Autoriza", "232db951-DGxa.aspx?User={0:F0}") & Eval("Anexo", "&Anexo={0:F0}") & Eval("Ministracion", "&ID={0:F0}") & Eval("CicloPagare", "&CicloPagare={0:F0}") %>' Text='<%# Eval("AnexoCon") %>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByDG" TypeName="WEBTasas.ProDSTableAdapters.AvioVoboTableAdapter">
            <SelectParameters>
        ...
        <asp:ObjectDataSource ID="vwDatos_DS" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="0" Name="CicloPagare" QueryStringField="CicloPagare" Type="String" />
            </SelectParameters>
        </asp:ObjectDataSource>
