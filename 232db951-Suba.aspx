<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="232db951-Suba.aspx.vb" Inherits="WEBTasas.SUBSucursalForm" %>
...
<body>
    ...
    <td align=center>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySUB" TypeName="WEBTasas.ProDSTableAdapters.AvioVoboTableAdapter">
            <SelectParameters>
