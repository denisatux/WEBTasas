<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="232db951-DGxo.aspx.vb" Inherits="WEBTasas.DGSucursalForm1" %>
...
<body>
    ...
    <td style="font-weight: bold; vertical-align: middle; color: white; font-family: Verdana; background-color: #f58220; text-align: center">
        <br />
        Solicitud de Ministraciones</td>
    </tr>
        <tr>
    <td align=center>
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1" EnableModelValidation="True" Font-Names="verdana,smaller" Font-Size="Smaller" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Anexo">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("Autoriza", "232db951-DGxo.aspx?User={0:F0}") & Eval("Anexo", "&Anexo={0:F0}") & Eval("Ministracion", "&ID={0:F0}") & Eval("CicloPagare", "&CicloPagare={0:F0}") %>' Text='<%# Eval("AnexoCon") %>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByDG_CRED" TypeName="WEBTasas.ProDSTableAdapters.AvioVoboTableAdapter">
            <SelectParameters>
