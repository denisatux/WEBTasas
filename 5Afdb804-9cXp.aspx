<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="5Afdb804-9cXp.aspx.vb" Inherits="WEBTasas.CPXFormMC" Culture="es-MX" uiCulture="es-MX" %>
...
<body>
    ...
    <td style="font-weight: bold; vertical-align: middle; color: white; font-family: Verdana; background-color: #f58220; text-align: center">
        <br />
        Autorizacion de Pagos Factoraje</td>
    </tr>
        <tr>
    <td align=center>
        <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="vwDatos_DS" Font-Names="verdana,smaller" Font-Size="Smaller" ForeColor="#333333" GridLines="None">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:CommandField ButtonType="Image" SelectImageUrl="~/IMG/check1.JPG" ShowSelectButton="True" />
                    <asp:BoundField DataField="NOMBRE" HeaderText="Beneficiario" SortExpression="NOMBRE" >
                    </asp:BoundField>
                    <asp:BoundField DataField="rfc" HeaderText="RFC" SortExpression="rfc" >
                    </asp:BoundField>
                    <asp:BoundField DataField="importe" HeaderText="Importe" SortExpression="importe" DataFormatString="{0:c}" HtmlEncode="False" >
                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                    </asp:BoundField>
                    <asp:BoundField DataField="moneda" HeaderText="moneda" SortExpression="moneda" />
                    <asp:BoundField DataField="clabe" HeaderText="Clabe" SortExpression="clabe" >
                    </asp:BoundField>
                    <asp:BoundField DataField="fecha" DataFormatString="{0:d}" HeaderText="Fecha" HtmlEncode="False" SortExpression="fecha" />
            ...
            <asp:ObjectDataSource ID="vwDatos_DS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="WEBTasas.CXP_DSTableAdapters.Vw_PagosFactor100TableAdapter">
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="VoboFactor" Name="Estatus" SessionField="User" Type="String" />
                </SelectParameters>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="100%" Width="100%">
            ...
            <br />
            <asp:Label ID="LbAutorizante0" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="#F58220" Text="Texto de Correo"></asp:Label>
            <br />
